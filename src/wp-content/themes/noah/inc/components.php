...
/**
 * Modify the Header Component Customify section options.
 *
 * @param array $options
 *
 * @return array
 */
function noah_change_customify_header_section_options( $options = array() ) {
	$options['header_section']['options']['header_logo_height']['css'] = array(
		array(
			'property' => 'max-height',
		...
		array(
			'property' => 'font-size',
			'selector' => '.site-title, .site-title.h1',
			'unit'     => 'px',
		),
	);
...
add_filter( 'pixelgrade_header_customify_section_options', 'noah_change_customify_header_section_options' );

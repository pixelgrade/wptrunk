			...
			'options' => array(
				...
				'main_content_body_link_color'          => array(
					...
					'css'     => array(
						array(
							'property' => 'color',
							'selector' => 'a, .c-slider__header .c-meta__share-link:hover',
						),
					),
				),
			...
			'options' => array(
				...
				'portfolio_items_aspect_ratio'             => array(
					...
					'css'         => array(
						array(
							'property'        => 'dummy',
							'selector'        => '.c-gallery--portfolio.c-gallery--regular .c-card__frame:after',
				...
				'portfolio_items_title_position'           => array(
					'type'    => 'radio',
					'label'   => esc_html__( 'Title Position', 'noah' ),
				...
				'portfolio_grid_title_items_meta_section'               => array(
					...
					'active_callback' => 'noah_portfolio_items_meta_control_show',
				),
				...
				'portfolio_item_thumbnail_hover_opacity' => array(
					...
					'css'         => array(
						array(
							'property' => 'opacity',
							'selector' => '.c-gallery--portfolio .c-card__link:hover .c-card__frame',
							'unit'     => '',
						),
					),
				),
			...
			'options' => array(
				...
				'blog_items_aspect_ratio'             => array(
					...
					'css'         => array(
						array(
							'property'        => 'dummy',
							'selector'        => '.c-gallery--blog.c-gallery--regular .c-card__frame:after',
							'callback_filter' => 'noah_aspect_ratio_cb',
							'unit'            => '%',
						),
					),
				...
				'blog_grid_title_items_meta_section'          => array(
					'type' => 'html',
					'html' => '<span class="separator sub-section label">' . esc_html__( 'Items Meta', 'noah' ) . '</span>',
					'active_callback' => 'noah_blog_items_meta_control_show',
				),
				...
				'blog_item_thumbnail_hover_opacity' => array(
					...
					'css'         => array(
						array(
							'property' => 'opacity',
							'selector' => '.c-gallery--blog .c-card__link:hover .c-card__frame',
							'unit'     => '',
						),
					),
				),
...
add_action( 'customize_preview_init', 'noah_portfolio_grid_spacing_cb_customizer_preview', 20 );
...
add_action( 'customize_preview_init', 'noah_blog_grid_spacing_cb_customizer_preview', 20 );
...
/**
 * Inline enqueues the JS code used in the Customizer for the aspect ratio live preview.
 */
...
function noah_aspect_ratio_cb( value, selector, property, unit ) {
	...
	css += selector + ' .c-card__frame:after {' +
		'padding-top: ' + padding +
		'}';
...
add_action( 'customize_preview_init', 'noah_aspect_ratio_cb_customizer_preview', 20 );

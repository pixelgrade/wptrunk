	...
	<div class="c-card">
		<div class="c-card__link">
			...
			<div class="c-card__content"><?php
				...
				if ( 'none' !== $items_primary_meta && ! empty( $meta[ $items_primary_meta ] ) ) {
				...
				if ( pixelgrade_option( 'blog_items_excerpt_visibility', true ) && get_the_excerpt() ) { ?>
					<div class="c-card__excerpt entry-content">
						...
						noah_maybe_read_more(); ?>
					</div><!-- .c-card__excerpt.entry-content -->
				<?php }

				if ( 'none' !== $items_secondary_meta && ! empty( $meta[ $items_secondary_meta ] ) ) {

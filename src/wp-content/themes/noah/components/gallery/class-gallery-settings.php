...
class Pixelgrade_Gallery_Settings {
	...
	function __construct() {
		...
		$this->gallery_spacing_options = array(
			...
			'small'  => esc_html__( 'Small', 'noah' ),
			'medium' => esc_html__( 'Medium', 'noah' ),
			'large'  => esc_html__( 'Large', 'noah' ),
			'xlarge' => esc_html__( 'X-Large', 'noah' ),
		);
	...
	function admin_init() {
		...
		wp_register_style( 'noah_gallery-admin-style', pixelgrade_get_theme_file_uri( 'components/gallery/css/admin.css' ), array(), $this->_assets_version );
	}
	...
	function wp_enqueue_media() {
		//wp_enqueue_style( 'noah_gallery-admin-style' );
		...
		if ( ! wp_script_is( 'pixelgrade-gallery-settings', 'registered' ) ) {
			wp_register_script( 'noah-gallery-settings', pixelgrade_get_theme_file_uri( 'components/gallery/js/gallery-settings.js' ), $dependecies, $this->_assets_version );
		}

		// Enqueue our script
		wp_enqueue_script( 'noah-gallery-settings' );
	}

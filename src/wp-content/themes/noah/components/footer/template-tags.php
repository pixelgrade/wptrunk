...
function footer_the_back_to_top_link() {
	$footer_hide_back_to_top_link = pixelgrade_option( 'footer_hide_back_to_top_link' );
	if ( empty( $footer_hide_back_to_top_link ) ) { ?>
		<a class="back-to-top" href="#"><?php esc_html_e( 'Back to Top', 'noah' ); ?></a>
	<?php }
}

function footer_the_copyright() {
	$copyright_text = pixelgrade_option( 'copyright_text', __( '%year% &copy; Handcrafted with love by <a href="#">Pixelgrade</a> Team', 'noah' ) );
